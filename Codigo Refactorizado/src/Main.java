public class Main {
    ...
    public static void main(String[] args) {
        ...
        Consulta consulta = new Consulta(05, 05, 2002, "12:05", paciente, medico, servicioMedico, "dvasdv", "asdvas",
                null);
    ...
    public static void inicializar() {
        ...
        ServicioMedico servicioMedico = new ServicioMedico("Psiquiatria", "rama que trata problemas mentales", 45.5,
                40);
